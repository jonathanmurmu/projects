#!/usr/bin/python
"""updates the preffered communication medium of the logged in user"""
...
try:
    sql_status = "UPDATE user_detail SET mail='{0}',message='{1}',phone_call='{2}',other='{3}' \
    where user_detail_id = {4}".format(mail, message, phone_call, other, user_detail_id)
