#!/usr/bin/python
"""Updating the personal information of the logged in user."""
...
def personal_update():
    ...
    # checking dropdown button value and assigning the value to variable
    ...
    # checking radio button value and assigning the value to variable
    if gender == "male":
        male = "checked"
    else:
        male = " "
    ...
    # checking checkbox button value and assigning the value to variable
    if mail == 1:
        mail = "checked"
    else:
        mail = " "
    ...
    # displaying apropriate error messages and retaining the field values
    if first_name in [None, '', "N/A", 'NULL', 'None']:
        ...
        try:
            sql_status = "UPDATE user_detail SET first_name='{0}',last_name='{1}',\
            date_of_birth='{2}',martial_status='{3}',gender='{4}' \
            WHERE user_detail_id = {5}".format(
                first_name, last_name, date_of_birth, martial_status, gender,
                user_detail_id
            )
            ...
            try:
                ...
                # checking dropdown button value and assigning to variable
                if martial_status == "single":
                    single = "selected"
                else:
                    single = " "
                ...
                # checking radio button value and assigning to variable
                if gender == "male":
                    male = "checked"
                else:
                    male = " "
                ...
                # checking checkbox button value and assigning to variable
                if mail == 1:
                    mail = "checked"
                else:
                    mail = " "
