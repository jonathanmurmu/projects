...
def register():
    """Register the new user and send an activation email."""
    cgitb.enable()
    ...
    if first_name in [None, '', "N/A", 'NULL', 'None']:
        ...
        print ''.join(line).format(
            first_name, last_name, male, female, date_of_birth, contact_number,
            email, username, password, confirm_password, message)
    ...
    # if both the passwords match then details will be saved in the data base
    elif password == confirm_password:

        try:
            sql = "INSERT INTO user_detail(first_name,last_name,gender,\
                date_of_birth,contact_number,email,username,password,status)\
            ...
            # retreiveing the id of the user and sending activation link
            try:
                cursor_id = db.cursor()
                sql_id = "SELECT user_detail_id FROM user_detail \
                ...
                try:
                    ...
                    print '<p>An activation link has been sent to your email ID</p>'
                except Exception as e:
                    # email sending error
                    message = e
                    line = open("../static/html_data/register_error.txt")
                    print ''.join(line).format(
                        first_name, last_name, male, female, date_of_birth,
        ...
        print ''.join(line).format(
            ...
            date_of_birth, contact_number, email, username, password,
            confirm_password, message
        )
