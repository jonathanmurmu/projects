#!/usr/bin/python
"""uploades the file to the directory called images 
and then updates the database column 'path' """
import cgi
import os
import MySQLdb
import cgitb
...
if fileitem.filename:
    ...
    try:
        sql="UPDATE user_detail SET image_path='{0}' WHERE user_detail_id='{1}'".format(path,user_detail_id)
        cursor.execute(sql)
        db.commit()
