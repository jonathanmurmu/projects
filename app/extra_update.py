#!/usr/bin/python
"""Updating the extra note of the logged in user."""
...
def extra_note_update():
    """Updating extra note in database."""
    cgitb.enable()
    ...
    try:
        sql_status = "UPDATE user_detail SET extra_note='{0}'\
         WHERE user_detail_id = {1}".format(extra_note, user_detail_id)
        ...
        try:
            ...
            gender,address_line_1,address_line_2,street,zip,contact_number,extra_note,\
            mail,message,phone_call,other,image_path FROM user_detail \
            ...
            print ''.join(line).format(
                ...
                contact_number, extra_note, mail, message, phone_call,
                other, user_detail_id, image_path)
            ...
            print '<body>'
            print '<h1>Oops!</h1>'
            print "<h2>Conection problem !!!</h2>"  # error in fetching records
